...
public class DBService {
    ...
    public void instantiateTestDatabase() throws ParseException {
        ...
        rac1.getPets().add(pet1);
        rac2.getPets().add(pet2);

        esp1.getRacas().add(rac1);
        esp2.getRacas().add(rac2);
        ...
        est2.getCidades().add(cid1);

        cid1.getEnderecos().add(end2);
        cid2.getEnderecos().add(end1);

        estadoRepository.saveAll(Arrays.asList(est1,est2));
        cidadeRepository.saveAll(Arrays.asList(cid1,cid2));

        end1.getPets().add(pet1);
        end2.getPets().add(pet2);
        ...
        prop1.getPets().add(pet1);
        prop2.getPets().add(pet2);

        pet1.getProprietarios().add(prop1);
        pet2.getProprietarios().add(prop2);
